...
@GFG(date = "26-05-2019", topic = "Queries on Left and Right Circular shift on array", url = "/queries-left-right-circular-shift-array/")
public class RotateAndQueryRangeSumTest {

    @Test
    @GFGMethod(date = "26-05-2019", algo = "using prefix sum and tracking rotation")
